...
public class SimulationGUI extends Application {
    ...
    public static SimulationGUI gui = null;
    
    public static SimulationGUI waitForGui() {
        try {
            latch.await();
    ...
    public static void setStartGui(SimulationGUI pGUI) {
        gui = pGUI;
        latch.countDown();
    }
    ...
    public void start(Stage stage) throws Exception {
       //StageStyle.UNDECORATED
        ...
        System.err.println(this.getClass().getClassLoader().getResource("../../../../Images/ville.png"));
