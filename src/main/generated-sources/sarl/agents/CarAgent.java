...
public class CarAgent extends Agent {
  ...
  @SyntheticMember
  private void $behaviorUnit$CarAgentIsDead$1(final CarAgentIsDead occurrence) {
  ...
  protected Direction memorizeAndMoveTo(final Direction direction) {
    return this.previousDirection = direction;
  }
  
  protected void randomMove(final List<Direction> directions) {
  }
  ...
  @SyntheticMember
  @PerceptGuardEvaluator
  private void $guardEvaluator$CarAgentIsDead(final CarAgentIsDead occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$CarAgentIsDead$1(occurrence));
  }
